...
class PyFilms(Base):
    """Pydantic models class meant to validate the data for `Films` object from
        single resource (https://swapi.dev/api/films/) endpoint from starwars API.
        """
...
if __name__ == "__main__":
    ...
    obj = PyFilms(**film_data)   # serialization / data validation
    print(obj)
